...
export default function SeriesHistoryPage() {
  ...
  const clearHistoryMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['subtitleHistory', 'series'] });
    },
  });
    ...
    <section className="space-y-4">
      <header className="flex items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold">Series History</h1>
          <p className="text-sm text-text-secondary">
            View subtitle download history for TV series.
          </p>
        </div>
      ...
      <QueryPanel
        ...
        emptyBody="Start downloading subtitles for series to see history here."
      >
        <DataTable
      ...
      <ConfirmModal
        ...
        description="This will permanently delete all series subtitle history. This action cannot be undone."
