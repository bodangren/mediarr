...
describe('MovieFileTable', () => {
  it('renders list of movie files', () => {
    render(<MovieFileTable files={mockFiles} />);
  ...
  it('calls onEdit when edit button is clicked', async () => {
    ...
    render(<MovieFileTable files={mockFiles} onEdit={handleEdit} />);
  ...
  it('calls onDelete when delete button is clicked', async () => {
    ...
    render(<MovieFileTable files={mockFiles} onDelete={handleDelete} />);
