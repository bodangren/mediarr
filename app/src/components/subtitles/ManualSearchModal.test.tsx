...
describe('ManualSearchModal', () => {
  ...
  describe('with movieId', () => {
    it('renders when open with movieId', () => {
      ...
      render(
        <ManualSearchModal isOpen={true} movieId={123} onClose={vi.fn()} />,
        { wrapper }
      );
    ...
    it('does not render when closed', () => {
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={false} movieId={123} onClose={vi.fn()} />,
        { wrapper }
      );
    ...
    it('calls manualDownload with movieId when download is clicked', async () => {
      ...
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={true} movieId={456} onClose={onClose} />,
        { wrapper }
      );
    ...
    it('renders subtitle candidates from search results', async () => {
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={true} movieId={789} onClose={vi.fn()} />,
        { wrapper }
      );
  ...
  describe('with episodeId', () => {
    it('renders when open with episodeId', () => {
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={true} episodeId={456} onClose={vi.fn()} />,
        { wrapper }
      );
    ...
    it('calls manualDownload with episodeId when download is clicked', async () => {
      ...
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={true} episodeId={789} onClose={onClose} />,
        { wrapper }
      );
  ...
  describe('common behavior', () => {
    it('calls onClose when Close button is clicked', async () => {
      ...
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={true} movieId={123} onClose={onClose} />,
        { wrapper }
      );
    ...
    it('shows empty state when no results found', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('No subtitle candidates found. Try adjusting your provider settings.')
        ).toBeInTheDocument();
      });
    });
    ...
    it('does not enable search when neither movieId nor episodeId is provided', () => {
      const wrapper = createWrapper();
      render(
        <ManualSearchModal isOpen={true} onClose={vi.fn()} />,
        { wrapper }
      );
