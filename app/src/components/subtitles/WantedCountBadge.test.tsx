...
describe('WantedCountBadge', () => {
  it('should not render when count is 0', () => {
    ...
    const { container } = renderWithProviders(<WantedCountBadge />);
  ...
  it('should render count badge with positive count', () => {
    ...
    renderWithProviders(<WantedCountBadge />);
  ...
  it('should apply custom className', () => {
    ...
    renderWithProviders(<WantedCountBadge className="custom-class" />);
  ...
  it('should poll every 30 seconds', () => {
    ...
    expect(mockUseApiQueryFn).toHaveBeenCalledWith(
