 ...
 */
export function loadColorImpairedMode(): boolean {
 ...
 */
export function applyColorImpairedMode(enabled: boolean): void {
 ...
 */
export function toggleColorImpairedMode(): boolean {
