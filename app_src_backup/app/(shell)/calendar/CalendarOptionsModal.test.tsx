...
describe('CalendarOptionsModal', () => {
  ...
  it('renders modal with title', () => {
    render(<CalendarOptionsModal {...defaultProps} />);
  ...
  it('toggles option when clicked', async () => {
    ...
    render(<CalendarOptionsModal {...defaultProps} onOptionsChange={onOptionsChange} />);
  ...
  it('calls onClose when Cancel is clicked', async () => {
    const onClose = vi.fn();
    render(<CalendarOptionsModal {...defaultProps} onClose={onClose} />);
  ...
  it('does not render when closed', () => {
    const { container } = render(
      <CalendarOptionsModal {...defaultProps} isOpen={false} />
    );
