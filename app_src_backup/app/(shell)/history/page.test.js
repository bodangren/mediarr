...
function renderPage(queryClient) {
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(HistoryPage, {}) }));
}
beforeEach(() => {
    vi.clearAllMocks();
    listActivityMock.mockImplementation(async (query) => {
    ...
    markFailedActivityMock.mockImplementation(async (id) => ({
        id,
        eventType: 'RELEASE_GRABBED',
