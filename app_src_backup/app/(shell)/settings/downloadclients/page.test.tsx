...
vi.mock('@/components/providers/ToastProvider', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/components/providers/ToastProvider')>();
  return {
    ...actual,
...
function renderPage() {
  ...
  return render(
    <QueryClientProvider client={queryClient}>
      <AppShell pathname="/settings/downloadclients">
        <SettingsDownloadClientsPage />
      </AppShell>
    </QueryClientProvider>,
  );
}
