...
describe('SubtitlesSettingsPage', () => {
    const renderPage = () => {
        ...
        return render(_jsx(QueryClientProvider, { client: client, children: _jsx(SubtitlesSettingsPage, {}) }));
    };
    it('renders page with header', () => {
        renderPage();
        expect(screen.getByText('Subtitle Settings')).toBeInTheDocument();
        expect(screen.getByText('Configure automatic subtitle downloads and file handling.')).toBeInTheDocument();
    });
