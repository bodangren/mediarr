  ...
  return (
    <section className="space-y-4">
      <header className="flex items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-semibold">Blacklisted Episode Subtitles</h1>
            {totalCount > 0 && (
          ...
          <p className="text-sm text-text-secondary">
            Manage blacklisted subtitles for TV series episodes.
          </p>
        </div>
        <Button
          variant="danger"
      ...
      <ConfirmModal
        ...
        description={`This will permanently remove all ${totalCount} blacklisted episode subtitles. This action cannot be undone.`}
