...
describe('SubtitlesPage', () => {
    const renderPage = () => {
        ...
        return render(_jsx(QueryClientProvider, { client: client, children: _jsx(SubtitlesPage, {}) }));
    };
    it('renders page with header', () => {
        renderPage();
        expect(screen.getByText('Subtitles')).toBeInTheDocument();
        expect(screen.getByText('Manage subtitle downloads, search history, language profiles, and provider settings.')).toBeInTheDocument();
    });
