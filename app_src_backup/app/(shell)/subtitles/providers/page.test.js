...
describe('SubtitleProvidersPage', () => {
    ...
    it('renders page header', () => {
        render(_jsx(SubtitleProvidersPage, {}));
        expect(screen.getByRole('heading', { level: 1, name: 'Subtitle Providers' })).toBeInTheDocument();
        expect(screen.getByText('Configure and manage subtitle providers for automatic subtitle downloads.')).toBeInTheDocument();
    });
    ...
    it('shows empty state when no providers', async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText('Configure subtitle providers to enable automatic subtitle downloads.')).toBeInTheDocument();
        });
    });
