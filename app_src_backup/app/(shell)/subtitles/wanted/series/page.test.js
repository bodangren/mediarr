...
vi.mock('@/components/subtitles/WantedCountBadge', () => ({
    WantedCountBadge: () => _jsx("span", { "data-testid": "wanted-count", children: "5" }),
}));
...
describe('WantedSeriesPage', () => {
    it('should render page header', () => {
        renderWithProviders(_jsx(WantedSeriesPage, {}));
    ...
    it('should render search input and language filter', () => {
        renderWithProviders(_jsx(WantedSeriesPage, {}));
        expect(screen.getByPlaceholderText('Search series or episode title...')).toBeInTheDocument();
