...
function buildLogFile(overrides = {}) {
    return {
...
function buildLogFileContents(overrides = {}) {
    return {
        filename: 'mediarr.log',
...
function renderPage(queryClient) {
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(LogsPage, {}) }));
}
...
describe('System Logs Page', () => {
    it('should render page header', () => {
        ...
        expect(screen.getByText('Browse and inspect structured log files.')).toBeInTheDocument();
    });
