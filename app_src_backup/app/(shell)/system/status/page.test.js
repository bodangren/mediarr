...
function buildSystemStatus(overrides = {}) {
    return {
        health: {
            overall: 'ok',
            checks: [
...
function renderPage(queryClient) {
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(SystemStatusPage, {}) }));
}
...
describe('System Status Page', () => {
    it('should render the page header', () => {
        ...
        expect(screen.getByText('System health, dependencies, and runtime diagnostics.')).toBeInTheDocument();
    });
