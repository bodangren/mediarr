...
vi.mock('@/lib/api/client', () => ({
    getApiClients: vi.fn(() => ({
        wantedApi: {
            listCutoffUnmetMovies: vi.fn(() => Promise.resolve({
                items: [
                    {
                        id: 1,
                        movieId: 201,
...
describe('MovieCutoffUnmetTab', () => {
    ...
    it('renders cutoff unmet movies table', () => {
        renderWithQueryClient(_jsx(MovieCutoffUnmetTab, { onSearchMovie: mockOnSearchMovie, onBulkSearch: mockOnBulkSearch }));
...
//# sourceMappingURL=MovieCutoffUnmetTab.test.js.map