...
function renderComponent(queryClient) {
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(MovieMissingTab, { onSearchMovie: mockOnSearchMovie, onBulkSearch: mockOnBulkSearch }) }));
}
const mockMissingMovies = [
    {
        id: 1,
        movieId: 101,
        title: 'Dune: Part Two',
...
//# sourceMappingURL=MovieMissingTab.test.js.map