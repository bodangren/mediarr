...
describe('CollectionCard', () => {
    ...
    it('renders collection card with all elements', () => {
        render(_jsx(CollectionCard, { collection: mockCollection, onToggleMonitored: mockOnToggleMonitored, onSearch: mockOnSearch, onEdit: mockOnEdit, onDelete: mockOnDelete }));
    ...
    it('shows unmonitored state correctly', () => {
        ...
        render(_jsx(CollectionCard, { collection: unmonitoredCollection, onToggleMonitored: mockOnToggleMonitored, onSearch: mockOnSearch, onEdit: mockOnEdit, onDelete: mockOnDelete }));
    ...
    it('handles missing poster with fallback', () => {
        ...
        render(_jsx(CollectionCard, { collection: collectionWithoutPoster, onToggleMonitored: mockOnToggleMonitored, onSearch: mockOnSearch, onEdit: mockOnEdit, onDelete: mockOnDelete }));
        const poster = screen.getByAltText('The Avengers Collection');
        expect(poster).toHaveAttribute('src', '/images/placeholder-poster.png');
    });
});
//# sourceMappingURL=CollectionCard.test.js.map