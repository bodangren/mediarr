...
describe('EditCollectionModal', () => {
    ...
    it('does not render when isOpen is false', () => {
        render(_jsx(EditCollectionModal, { collection: mockCollection, isOpen: false, onClose: mockOnClose, onSave: mockOnSave }));
        expect(screen.queryByText('Edit Collection')).not.toBeInTheDocument();
    });
    it('renders modal when isOpen is true', () => {
        render(_jsx(EditCollectionModal, { collection: mockCollection, isOpen: true, onClose: mockOnClose, onSave: mockOnSave }));
    ...
    it('displays unmonitored checkbox correctly', () => {
        ...
        render(_jsx(EditCollectionModal, { collection: unmonitoredCollection, isOpen: true, onClose: mockOnClose, onSave: mockOnSave }));
        const monitoredCheckbox = screen.getByLabelText('Monitored');
        expect(monitoredCheckbox).not.toBeChecked();
    });
});
//# sourceMappingURL=EditCollectionModal.test.js.map