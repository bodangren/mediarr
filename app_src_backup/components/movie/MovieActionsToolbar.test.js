...
describe('MovieActionsToolbar', () => {
    it('renders all action buttons', () => {
        ...
        render(_jsx(MovieActionsToolbar, { ...handlers }));
    ...
    it('does not render delete button when onDelete not provided', () => {
        render(_jsx(MovieActionsToolbar, {}));
