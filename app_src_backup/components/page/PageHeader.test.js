...
describe('PageHeader', () => {
    it('renders title', () => {
        render(_jsx(PageHeader, { title: "Test Page", onMenuToggle: vi.fn() }));
    ...
    it('calls onMenuToggle when menu button is clicked', () => {
        ...
        render(_jsx(PageHeader, { title: "Test Page", onMenuToggle: handleToggle }));
        const menuButton = screen.getByRole('button', { name: 'Toggle sidebar' });
    ...
    it('renders actions when provided', () => {
        ...
        render(_jsx(PageHeader, { title: "Test Page", onMenuToggle: vi.fn(), actions: testAction }));
        expect(screen.getByText('Test Action')).toBeInTheDocument();
    });
    it('does not render actions when not provided', () => {
        const { container } = render(_jsx(PageHeader, { title: "Test Page", onMenuToggle: vi.fn() }));
    ...
    it('truncates long titles', () => {
        ...
        render(_jsx(PageHeader, { title: longTitle, onMenuToggle: vi.fn() }));
    ...
    it('renders multiple actions', () => {
        const actions = (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", children: "Action 1" }), _jsx("button", { type: "button", children: "Action 2" }), _jsx("button", { type: "button", children: "Action 3" })] }));
        render(_jsx(PageHeader, { title: "Test Page", onMenuToggle: vi.fn(), actions: actions }));
