...
import { Menu, MenuButton, MenuTrigger } from './Menu';
describe('Menu primitives', () => {
    describe('Menu component', () => {
        it('renders dropdown menu with items and closes on backdrop click', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: onClose, items: items, ariaLabel: "Actions menu" }));
        ...
        it('does not render when closed', () => {
            ...
            render(_jsx(Menu, { isOpen: false, onClose: () => { }, items: items, ariaLabel: "Hidden menu" }));
            expect(screen.queryByRole('menu')).not.toBeInTheDocument();
        });
        it('closes on escape key press', () => {
            const onClose = vi.fn();
            const items = [{ key: 'edit', label: 'Edit' }];
            render(_jsx(Menu, { isOpen: true, onClose: onClose, items: items, ariaLabel: "Escape menu" }));
        ...
        it('fires item click handler and closes menu', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: onClose, items: items, ariaLabel: "Click menu" }));
        ...
        it('renders disabled items without click handler', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: onClose, items: items, ariaLabel: "Disabled menu" }));
        ...
        it('renders dividers between items', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Divider menu" }));
        ...
        it('renders items with icons', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Icon menu" }));
            expect(screen.getByRole('menuitem', { name: 'Download' })).toBeInTheDocument();
            expect(screen.getByRole('menuitem', { name: 'Edit' })).toBeInTheDocument();
        });
        it('aligns menu to the right when specified', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            const { container } = render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, align: "right", ariaLabel: "Right menu" }));
        ...
        it('aligns menu to the left by default', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            const { container } = render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Left menu" }));
            const menu = screen.getByRole('menu');
        ...
        it('applies custom className to menu', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, className: "custom-class", ariaLabel: "Custom menu" }));
            const menu = screen.getByRole('menu');
        ...
        it('renders multiple dividers correctly', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Multi-divider menu" }));
            const dividers = screen.getAllByTestId('menu-divider');
            expect(dividers).toHaveLength(2);
        });
        it('handles empty items array', () => {
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: [], ariaLabel: "Empty menu" }));
            const menu = screen.getByRole('menu');
    ...
    describe('MenuTrigger component', () => {
        it('renders trigger button with children', () => {
            render(_jsx(MenuTrigger, { children: "Open Menu" }));
            expect(screen.getByRole('button', { name: 'Open Menu' })).toBeInTheDocument();
        });
        it('calls onClick handler when clicked', () => {
            const onClick = vi.fn();
            render(_jsx(MenuTrigger, { onClick: onClick, children: "Trigger" }));
            fireEvent.click(screen.getByRole('button', { name: 'Trigger' }));
            expect(onClick).toHaveBeenCalledTimes(1);
        });
        it('disables button when disabled prop is true', () => {
            render(_jsx(MenuTrigger, { disabled: true, children: "Disabled Trigger" }));
            expect(screen.getByRole('button', { name: 'Disabled Trigger' })).toBeDisabled();
        });
        it('applies custom ariaLabel', () => {
            render(_jsx(MenuTrigger, { ariaLabel: "Custom label", children: "Trigger" }));
    ...
    describe('MenuButton component', () => {
        it('opens menu when trigger button is clicked', () => {
            ...
            render(_jsx(MenuButton, { items: items, ariaLabel: "Test menu", children: "More Options" }));
            // Initially closed
            expect(screen.queryByRole('menu')).not.toBeInTheDocument();
            // Click to open
        ...
        it('closes menu when item is clicked', () => {
            ...
            render(_jsx(MenuButton, { items: items, ariaLabel: "Close test menu", children: "Menu" }));
            // Open menu
        ...
        it('closes menu when backdrop is clicked', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            render(_jsx(MenuButton, { items: items, ariaLabel: "Backdrop test menu", children: "Menu" }));
            // Open menu
            fireEvent.click(screen.getByRole('button', { name: 'Menu' }));
            expect(screen.getByRole('menu')).toBeInTheDocument();
            // Click backdrop
        ...
        it('closes menu on escape key', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            render(_jsx(MenuButton, { items: items, ariaLabel: "Escape test menu", children: "Menu" }));
            // Open menu
            fireEvent.click(screen.getByRole('button', { name: 'Menu' }));
            expect(screen.getByRole('menu')).toBeInTheDocument();
            // Press escape
        ...
        it('supports right-aligned menus', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            render(_jsx(MenuButton, { items: items, align: "right", ariaLabel: "Right aligned menu", children: "Menu" }));
            // Open menu
            fireEvent.click(screen.getByRole('button', { name: 'Menu' }));
            const menu = screen.getByRole('menu');
            expect(menu).toHaveClass('right-0');
    ...
    describe('Menu accessibility', () => {
        it('has proper ARIA roles', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Accessibility menu" }));
            const menu = screen.getByRole('menu');
        ...
        it('has disabled items with proper ARIA', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Disabled ARIA menu" }));
        ...
        it('renders dividers with separator role', () => {
            ...
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Separator menu" }));
        ...
        it('backdrop has proper aria-label', () => {
            const items = [{ key: 'edit', label: 'Edit' }];
            render(_jsx(Menu, { isOpen: true, onClose: () => { }, items: items, ariaLabel: "Backdrop ARIA menu" }));
