...
describe('SortMenu', () => {
    ...
    it('renders correctly with initial values', () => {
        render(_jsx(SortMenu, { options: defaultOptions, value: "title", direction: "asc", onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
    ...
    it('renders with custom label', () => {
        render(_jsx(SortMenu, { options: defaultOptions, value: "date", direction: "desc", label: "Order", onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
    ...
    it('displays down arrow icon for descending direction', () => {
        render(_jsx(SortMenu, { options: defaultOptions, value: "title", direction: "desc", onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
    ...
    it('handles multiple direction toggles', async () => {
        const { rerender } = render(_jsx(SortMenu, { options: defaultOptions, value: "title", direction: "asc", onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
        const directionButton = screen.getByLabelText(/toggle sort direction/i);
        // First click: asc -> desc
        await userEvent.click(directionButton);
        expect(mockOnDirectionChange).toHaveBeenLastCalledWith('desc');
        // Rerender with new direction
        rerender(_jsx(SortMenu, { options: defaultOptions, value: "title", direction: "desc", onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
        // Second click: desc -> asc
        await userEvent.click(directionButton);
        expect(mockOnDirectionChange).toHaveBeenLastCalledWith('asc');
        // Rerender with new direction
        rerender(_jsx(SortMenu, { options: defaultOptions, value: "title", direction: "asc", onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
    ...
    describe('direction types', () => {
        it.each(['asc', 'desc'])('renders correctly with %s direction', direction => {
            render(_jsx(SortMenu, { options: defaultOptions, value: "title", direction: direction, onChange: mockOnChange, onDirectionChange: mockOnDirectionChange }));
