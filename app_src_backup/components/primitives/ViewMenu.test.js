...
describe('ViewMenu', () => {
    ...
    it('renders correctly with initial value', () => {
        render(_jsx(ViewMenu, { value: "poster", onChange: mockOnChange }));
    ...
    it('renders with custom label', () => {
        render(_jsx(ViewMenu, { value: "table", onChange: mockOnChange, label: "Display" }));
    ...
    it('highlights active view with checkmark', async () => {
        render(_jsx(ViewMenu, { value: "overview", onChange: mockOnChange }));
    ...
    it('displays correct icon for each view mode', async () => {
        render(_jsx(ViewMenu, { value: "table", onChange: mockOnChange }));
    ...
    describe('view modes', () => {
        it.each(['poster', 'overview', 'table'])('renders correct label for %s mode', viewMode => {
            render(_jsx(ViewMenu, { value: viewMode, onChange: mockOnChange }));
...
//# sourceMappingURL=ViewMenu.test.js.map