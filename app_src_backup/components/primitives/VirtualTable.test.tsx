...
describe('VirtualTable', () => {
  const columns: TableColumn<RowModel>[] = [
    { key: 'name', header: 'Name', sortable: true, render: (row: RowModel) => row.name },
    { key: 'status', header: 'Status', sortable: false, render: (row: RowModel) => row.status },
  ];

  const generateData = (count: number): RowModel[] => {
