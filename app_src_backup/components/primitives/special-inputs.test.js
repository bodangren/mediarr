...
describe('Specialized inputs', () => {
    it('toggles password visibility and propagates input changes', () => {
        ...
        render(_jsx(PasswordInput, { id: "apiPassword", value: "secret", onChange: onChange }));
    ...
    it('supports path input editing and browse action callback', () => {
        ...
        render(_jsx(PathInput, { id: "downloadPath", value: "/downloads", onChange: onChange, onBrowse: onBrowse }));
    ...
    it('normalizes numeric input values within bounds', () => {
        const onChange = vi.fn();
        render(_jsx(NumberInput, { id: "priority", value: 10, min: 0, max: 50, onChange: onChange }));
    ...
    it('filters autocomplete suggestions and selects an option', () => {
        ...
        render(_jsx(AutoCompleteInput, { id: "indexerSearch", value: "", suggestions: ['NinjaCentral', 'RARBG', '1337x'], onChange: onChange, onSelect: onSelect }));
...
//# sourceMappingURL=special-inputs.test.js.map