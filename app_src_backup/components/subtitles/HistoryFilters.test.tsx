...
describe('HistoryFilters', () => {
  ...
  it('calls onChange when provider changes', async () => {
    ...
    render(<HistoryFilters {...defaultProps} onChange={handleChange} />);
  ...
  it('calls onChange with empty value when clearing provider', async () => {
    const handleChange = vi.fn();
    const filters: FilterState = { provider: 'OpenSubtitles' };
    render(<HistoryFilters {...defaultProps} onChange={handleChange} filters={filters} />);
  ...
  it('displays current filter values', () => {
    ...
    render(<HistoryFilters {...defaultProps} filters={filters} />);
