...
describe('LanguageSettingRow', () => {
    ...
    it('renders language name and code', () => {
        render(_jsx(LanguageSettingRow, { setting: mockSetting, onChange: handleChange, onRemove: handleRemove }));
    ...
    it('is disabled when disabled prop is true', () => {
        render(_jsx(LanguageSettingRow, { setting: mockSetting, onChange: handleChange, onRemove: handleRemove, disabled: true }));
        const forcedCheckbox = screen.getByLabelText('Forced');
        const hiCheckbox = screen.getByLabelText('HI');
        const audioExcludeCheckbox = screen.getByLabelText('Audio Exclude');
        const scoreInput = screen.getByLabelText('en score');
    ...
    it('renders with all checkboxes checked', () => {
        ...
        render(_jsx(LanguageSettingRow, { setting: allChecked, onChange: handleChange, onRemove: handleRemove }));
...
//# sourceMappingURL=LanguageSettingRow.test.js.map