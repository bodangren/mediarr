...
describe('MovieOverviewView', () => {
    it('renders movie overview cards', () => {
        ...
        render(_jsx(MovieOverviewView, { items: mockMovies, onToggleMonitored: onToggleMonitored }));
    ...
    it('calls onDelete when delete button is clicked', () => {
        ...
        render(_jsx(MovieOverviewView, { items: mockMovies, onToggleMonitored: onToggleMonitored, onDelete: onDelete }));
        const firstMovieCard = screen.getByText('The Matrix').closest('article');
    ...
    it('calls onSearch when search button is clicked', () => {
        ...
        render(_jsx(MovieOverviewView, { items: mockMovies, onToggleMonitored: onToggleMonitored, onSearch: onSearch }));
        const firstMovieCard = screen.getByText('The Matrix').closest('article');
    ...
    it('displays empty state when no items', () => {
        const onToggleMonitored = vi.fn();
        render(_jsx(MovieOverviewView, { items: [], onToggleMonitored: onToggleMonitored }));
    ...
    it('shows loading skeletons when isLoading is true', () => {
        const onToggleMonitored = vi.fn();
        render(_jsx(MovieOverviewView, { items: [], onToggleMonitored: onToggleMonitored, isLoading: true }));
    ...
    it('handles missing posterUrl with fallback', () => {
        ...
        render(_jsx(MovieOverviewView, { items: [movieWithoutPoster], onToggleMonitored: onToggleMonitored }));
    ...
    it('does not show "Show more" button when overview is missing', () => {
        ...
        render(_jsx(MovieOverviewView, { items: [movieWithoutOverview], onToggleMonitored: onToggleMonitored }));
        // "Show more" button should not be visible
        expect(screen.queryByText('Show more')).not.toBeInTheDocument();
    });
});
//# sourceMappingURL=MovieOverviewView.test.js.map