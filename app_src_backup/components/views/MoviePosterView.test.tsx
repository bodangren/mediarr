...
describe('MoviePosterView', () => {
  it('renders movie poster cards', () => {
    ...
    render(<MoviePosterView items={mockMovies} onToggleMonitored={onToggleMonitored} />);
  ...
  it('displays empty state when no items', () => {
    const onToggleMonitored = vi.fn();
    render(<MoviePosterView items={[]} onToggleMonitored={onToggleMonitored} />);
  ...
  it('shows loading skeletons when isLoading is true', () => {
    const onToggleMonitored = vi.fn();
    render(<MoviePosterView items={[]} onToggleMonitored={onToggleMonitored} isLoading />);
  ...
  it('handles missing posterUrl with fallback', () => {
    const onToggleMonitored = vi.fn();
    render(<MoviePosterView items={[mockMovies[2]]} onToggleMonitored={onToggleMonitored} />);
