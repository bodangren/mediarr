...
describe('SeriesOverviewView', () => {
    it('renders series overview cards', () => {
        ...
        render(_jsx(SeriesOverviewView, { items: mockSeries, onToggleMonitored: onToggleMonitored }));
    ...
    it('calls onDelete when delete button is clicked', () => {
        ...
        render(_jsx(SeriesOverviewView, { items: mockSeries, onToggleMonitored: onToggleMonitored, onDelete: onDelete }));
    ...
    it('displays empty state when no items', () => {
        const onToggleMonitored = vi.fn();
        render(_jsx(SeriesOverviewView, { items: [], onToggleMonitored: onToggleMonitored }));
...
//# sourceMappingURL=SeriesOverviewView.test.js.map