...
describe('SeriesPosterView', () => {
    it('renders series poster cards', () => {
        ...
        render(_jsx(SeriesPosterView, { items: mockSeries, onToggleMonitored: onToggleMonitored }));
    ...
    it('calls onDelete when delete button is clicked', () => {
        ...
        render(_jsx(SeriesPosterView, { items: mockSeries, onToggleMonitored: onToggleMonitored, onDelete: onDelete }));
    ...
    it('displays empty state when no items', () => {
        const onToggleMonitored = vi.fn();
        render(_jsx(SeriesPosterView, { items: [], onToggleMonitored: onToggleMonitored }));
...
//# sourceMappingURL=SeriesPosterView.test.js.map