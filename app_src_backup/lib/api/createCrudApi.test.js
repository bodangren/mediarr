...
describe('createCrudApi', () => {
    ...
    const crudApi = createCrudApi(mockHttpClient, {
    ...
    it('should use custom listSchema if provided', async () => {
        const customListSchema = z.array(itemSchema.extend({
            extraField: z.string(),
        }));
        const customCrudApi = createCrudApi(mockHttpClient, {
...
//# sourceMappingURL=createCrudApi.test.js.map