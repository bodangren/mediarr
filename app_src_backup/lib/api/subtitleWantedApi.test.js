...
describe('subtitleWantedApi', () => {
    ...
    const api = createSubtitleWantedApi(mockClient);
    beforeEach(() => {
        vi.clearAllMocks();
    });
    describe('listWantedSeries', () => {
        it('should fetch paginated wanted series entries', async () => {
            ...
            expect(mockClient.requestPaginated).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=subtitleWantedApi.test.js.map