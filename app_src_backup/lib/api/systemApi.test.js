    ...
    describe('Tasks API', () => {
        ...
        describe('getTaskHistory', () => {
            ...
            it('should support filtering by status', async () => {
                ...
                client.requestPaginated = mockRequestPaginated;
                const api = createSystemApi(client);
                const query = { page: 1, pageSize: 25, status: 'failed' };
        ...
        describe('Events API', () => {
            describe('getEvents', () => {
                ...
                it('should support filtering by level', async () => {
                    ...
                    client.requestPaginated = mockRequestPaginated;
                    const api = createSystemApi(client);
                    const query = { page: 1, pageSize: 25, level: 'error' };
                ...
                it('should support filtering by type', async () => {
                    ...
                    client.requestPaginated = mockRequestPaginated;
                    const api = createSystemApi(client);
                    const query = { page: 1, pageSize: 25, type: 'indexer' };
                    await api.getEvents(query);
                    expect(mockRequestPaginated).toHaveBeenCalledWith({
                        path: '/api/system/events',
                        query,
...
//# sourceMappingURL=systemApi.test.js.map