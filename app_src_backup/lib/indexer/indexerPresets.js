 ...
 */
export function getPresetsByProtocol(protocol) {
 ...
 */
export function getPresetsByPrivacy(privacy) {
...
export function searchPresets(query) {
    ...
    return indexerPresets.filter((preset) => preset.name.toLowerCase().includes(lowercaseQuery) ||
        preset.description.toLowerCase().includes(lowercaseQuery));
}
//# sourceMappingURL=indexerPresets.js.map