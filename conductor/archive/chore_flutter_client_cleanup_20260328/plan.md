...
- [ ] Task: Conductor - User Manual Verification 'Fix Compile Errors'
...
- [ ] Task: Conductor - User Manual Verification 'Remove Dead Code & Deduplicate'
...
- [ ] Task: Conductor - User Manual Verification 'Reorganize Misplaced Code'
...
- [ ] Task: Conductor - User Manual Verification 'Fix Fragile Patterns'
...
- [ ] Task: Conductor - User Manual Verification 'Fix Tests & Implement Settings Screen'
