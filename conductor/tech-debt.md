...
| 2026-03-30 | chore_drizzle_migration_20260314 | 18 of 20 repos still on Prisma; `main.ts` in mixed state during Phase 2 | High | Open | Track in progress — Phase 2 (8 repos) + Phase 3 (8 repos + main.ts/services/routes) + Phase 4 (Prisma removal) remaining |
