...
- [ ] **Track: Manual Test Findings and Player-First Client Debugging** *Phases: 4 | Link: [./tracks/bug_manual_test_player_client_findings_20260417/](./tracks/bug_manual_test_player_client_findings_20260417/)* — movie search empty, TV add FK failure, Flutter discovery, SSE event-name drift, player-first UX correction
