...
- [~] Task: Measure - User Manual Verification 'Phase 1: Scaffolding & Discovery' (started in deferred batch; see `verification_20260305.md`).
...
- [~] Task: Measure - User Manual Verification 'Phase 2: Media Browsing & Detail View' (started in deferred batch; see `verification_20260305.md`).
...
- [~] Task: Measure - User Manual Verification 'Phase 3: Playback & Syncing' (blocked pending Phase 1/2 UI interaction fixes).
...
- Evidence note: `measure/tracks/android_tv_client_20260304/verification_20260305.md`
...
- Expected commit message: `chore(measure): complete deferred manual verification for android tv track`
