...
- Align the server event, Flutter client listener, and Measure Activity & Queue plan/spec wording.
...
- SSE event naming is consistent across server, Flutter client, tests, and Measure docs.
