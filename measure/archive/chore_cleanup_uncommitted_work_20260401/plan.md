...
## Phase 1 — Revert secrets, remove junk, sort measure state

- [x] Revert `.env` to HEAD (API keys must not be tracked) — 2cf5b28
- [x] Delete junk files: `measure/opencode-cron.log`, `measure/opencode-last-run.log`, `measure/test-errors.txt`, `server/test-real-batch.ts` — 2cf5b28
- [x] Delete `mediarr.db.prisma.bak` (database backup, not source) — 2cf5b28
- [x] Commit measure track archival moves (deleted from `tracks/`, added to `archive/`) — 2cf5b28
