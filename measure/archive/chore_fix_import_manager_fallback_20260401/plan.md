...
- [x] Add test: parsed as episode, series NOT found → falls through to movie path and imports
- [x] Add test: parsed as episode, series found but episode NOT found → falls through to movie path and imports
- [x] Add test: parsed as episode, series found, episode NOT found, movie also NOT found → IMPORT_FAILED (no match)
- [x] Run `CI=true bun run test --run 2>&1 | tail -40` — confirm all pass
...
- [x] Update `measure/tech-debt.md`: mark ImportManager fallback bug as Resolved
