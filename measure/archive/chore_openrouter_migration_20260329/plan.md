...
- [x] Task: Measure - User Manual Verification 'Install & Environment'
...
- [x] Task: Measure - User Manual Verification 'Migrate ReleaseParser'
...
- [x] Task: Measure - User Manual Verification 'Update Tests'
...
- [x] Task: Measure - User Manual Verification 'Smoke Test & Verification'
