...
- Evidence report: `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/backend-probe-report.json`

## Capability Classification

| Capability ID | Parity Status | Severity | Confidence | Evidence Type | Key Evidence |
| --- | --- | --- | --- | --- | --- |
| `prowlarr.indexer.definition-ingestion` | `REGRESSION` | `P0` | `high` | verified | `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/definition-wiring-probe.txt`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/indexer-cardigann-test-body.v2.json`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/release-search-body.v2.json` |
| `prowlarr.indexer.contract-shape` | `PARTIAL_IMPLEMENTATION` | `P1` | `high` | verified | `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/indexer-create-invalid-body.v2.json`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/indexer-create-valid-body.v2.json`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/indexer-test-body.v2.json` |
| `sonarr.metadata.tv-search` | `MISSING` | `P1` | `medium` | verified | `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/metadata-tv-search-body.v2.json` |
| `radarr.metadata.movie-search` | `MISSING` | `P0` | `high` | verified + inferred | verified: `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/metadata-movie-search-body.v2.json`; inferred: TMDB upstream behavior variability |
| `core.release.search-grab-side-effects` | `PARTIAL_IMPLEMENTATION` | `P1` | `high` | verified | `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/release-search-body.v2.json`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/release-grab-body.v2.json`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/activity-after-grab-body.v2.json` |
| `bazarr.variant.subtitle-operations` | `PARTIAL_IMPLEMENTATION` | `P1` | `high` | verified | `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/subtitles-search-missing-ids-body.json`, `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/subtitles-search-movie-multi-variant-body.json` |
...
- **Verified:** all HTTP response captures under `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/` and the deterministic probe outputs in `backend-probe-report.json`.
