...
- Matrix source: `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/parity-matrix.json`
- Runtime evidence sources:
  - `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/`
  - `measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/`

## Output Artifact
- `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/validation-integrity-report.json`
