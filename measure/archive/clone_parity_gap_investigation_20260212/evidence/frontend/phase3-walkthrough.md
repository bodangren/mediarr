...
- Source: `measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/pages/status-summary.txt`
...
- Source: `measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/api/`
...
## Mapping Notes
- Frontend gaps are mapped to backend parity IDs in `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/frontend-parity-report.json` under `backendCapabilityLinks`.
