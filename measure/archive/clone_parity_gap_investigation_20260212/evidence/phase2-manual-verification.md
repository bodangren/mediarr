...
2. Execute probe commands recorded in `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/backend-probe-report.json`.
3. Verify raw response evidence under `measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/`.
4. Validate findings classification against `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/backend-findings.md`.
