...
3. Execute route/API walkthrough commands documented in `measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/phase3-walkthrough.md`.
4. Validate structured surface classifications in `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/frontend-parity-report.json`.
