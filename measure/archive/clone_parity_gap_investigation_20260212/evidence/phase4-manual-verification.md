...
- `source`: `measure/tracks/clone_parity_gap_investigation_20260212/plan.md`
...
## Manual Reproduction
1. Regenerate analyzer output: `node measure/tracks/clone_parity_gap_investigation_20260212/scripts/generate-validation-integrity-report.mjs`.
2. Verify policy and flow coverage in `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/validation-integrity-report.json`.
3. Validate findings narrative in `measure/tracks/clone_parity_gap_investigation_20260212/artifacts/validation-findings.md`.
