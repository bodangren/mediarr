...
const trackRoot = path.join(repoRoot, 'measure', 'tracks', 'clone_parity_gap_investigation_20260212');
...
const supplementalRuntimeEvidence = {
  'core.settings.persistence': [
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/api/settings-get.json',
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/api/settings-patch.json',
  ],
  'core.activity.timeline': [
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/runtime/activity-after-grab-body.v2.json',
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/pages/_activity.html',
  ],
  'core.queue.operations': [
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/api/queue-list.json',
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/api/queue-pause.json',
    'measure/tracks/clone_parity_gap_investigation_20260212/evidence/frontend/runtime/api/queue-resume.json',
  ],
};
