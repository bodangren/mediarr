...
- [ ] Task: Measure - User Manual Verification 'Phase 1: Database & Metadata Sync' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 2: Collections API' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Frontend Collections UI' (Protocol in workflow.md) (3ad372f)
