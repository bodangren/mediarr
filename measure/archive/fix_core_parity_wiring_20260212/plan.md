...
- [x] Task: Measure - User Manual Verification 'Phase 1: Critical Core Wiring (P0 Blockers)' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Operational Scaffolding (High-Impact P1)' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 3: Feature Parity (P1 Gaps)' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 4: Reliability & Polish (P2/P3)' (Protocol in workflow.md)
