...
- [x] Task: Measure - User Manual Verification 'Phase 1: Complete Directory & Seed Controls' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Movie & TV Root Folders' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Import Pipeline Hardening' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 4: Seed Ratio Enforcement' (Protocol in workflow.md)
