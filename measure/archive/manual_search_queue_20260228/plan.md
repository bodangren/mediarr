...
- [x] Task: Measure - User Manual Verification 'Phase 1: Quality Profile Presets & Drag-to-Reorder' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Series Interactive Search Modal' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Download Location File Browser' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 4: Activity Queue Page' (Protocol in workflow.md)
...
- [x] Task: Build `ActivityHistoryPage` component [6a34eadf]
    - [x] Write rendering tests: renders history rows, event type badges, filters, pagination, empty state, Mark Failed action
    - [x] Create `app/src/components/activity/ActivityHistoryPage.tsx`:
...
- [x] Task: Measure - User Manual Verification 'Phase 5: Activity History Page' (Protocol in workflow.md)
