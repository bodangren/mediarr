...
- [x] **Task: Measure - User Manual Verification 'Phase 1'** (commit: `6f041d8`)
...
- [x] **Task: Measure - User Manual Verification 'Phase 2'** (commit: `2fe545c`)
...
- [x] **Task: Measure - User Manual Verification 'Phase 3'** (commit: `d399df0`)
...
- [x] **Task: Measure - User Manual Verification 'Phase 4'** (commit: `53af60d`)
...
- [x] **Task: Measure - User Manual Verification 'Phase 5'** (commit: `e98f703`)
...
- [ ] **Task: Measure - User Manual Verification 'Phase 8'**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 9'**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 10'**
