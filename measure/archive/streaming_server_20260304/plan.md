...
- [x] Task: Measure - User Manual Verification 'Phase 1: Persistence & Discovery' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Playback APIs & Streaming' (Protocol in workflow.md)

## Phase 3: Integration & Testing
- [x] Task: Write integration tests for Range-based HTTP streaming (mocking partial requests).
- [x] Task: Verify mDNS broadcast on a local network interface.
- [x] Task: Measure - User Manual Verification 'Phase 3: Integration & Testing' (Protocol in workflow.md)
