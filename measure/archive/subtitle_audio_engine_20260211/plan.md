...
- [x] Task: Measure - User Manual Verification 'Phase 1: Bazarr Parity Rules & Domain Contracts' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Schema, Migration, and Repository Layer' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Probe Parsing and Inventory Indexing' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 4: Missing Subtitle Computation and Wanted Generation' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 5: Subtitle Fetching, Processing, and History' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 6: API Surface and Manual Operations' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 7: Backfill, Performance, and End-to-End Validation' (Protocol in workflow.md)
