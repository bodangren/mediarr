...
### Task 2.2: Update measure tracking
...
- Test command: `git diff -- measure/tracks/subtitle_inventory_disk_import_recovery_20260307`
- Expected commit message: `measure(plan): update subtitle disk import recovery status`
