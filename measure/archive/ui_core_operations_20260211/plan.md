...
- [x] Task: Define and implement design token system.
  - [x] Sub-task: Create design token reference document in `measure/` defining all color ramps (surface 0-3, text primary/secondary/muted, accent, semantic states), spacing scale (4px grid), type scale (12-32px with Geist Sans/Mono), radius (0/4/8/12/9999), and shadow levels (3 tiers).
...
- [x] Task: Measure - User Manual Verification 'Phase 1: Frontend Infrastructure, Design Tokens, and Data Architecture' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: App Shell, Navigation, and Global Interactions' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Indexer Management Console' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 4: Add Media Discovery and Onboarding Flows' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 5: Library List and Detail Views' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 6: Wanted View and Release Selection Flow' (Protocol in workflow.md)
