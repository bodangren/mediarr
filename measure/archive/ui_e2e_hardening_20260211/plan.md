...
- [ ] Task: Measure - User Manual Verification 'Phase 1: Playwright Infrastructure and Desktop E2E Journeys' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 2: Mobile E2E Journeys and Accessibility Audit' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 3: Performance Validation and Final UX Consistency Pass' (Protocol in workflow.md)
