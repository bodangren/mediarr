...
- [ ] Task: Measure - User Manual Verification 'Phase 1: Torrent Queue Console and Control Surface' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 2: Subtitle Variant Console and Manual Operations' (Protocol in workflow.md)
