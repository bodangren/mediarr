...
- [x] Task: Implement process model validation spike.
  ...
  - [x] Sub-task: Document validated architecture, constraints, and port configuration in `measure/tech-stack.md`.
...
- [x] Task: Measure - User Manual Verification 'Phase 1: Baseline Stabilization and Process Model Spike' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Serialization, Error Taxonomy, and Search Refactor' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Torrent Stats Persistence and Subtitle Provider Factory' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 4: App Settings and Indexer Health Primitives' (Protocol in workflow.md)
...
- [x] Task: Measure - User Manual Verification 'Phase 5: Activity Event System' (Protocol in workflow.md)
