...
- [ ] Task: Measure - User Manual Verification 'Phase 2: Server API Surface Layer' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 3: Frontend Foundation — Test Infrastructure, Design System, and App Shell' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 4: Indexer Management Console (Prowlarr-Inspired)' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 5: Media Discovery and Add Workflows' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 6: Library Views and Wanted Management' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 7: Release Selection and Queue Handoff' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 8: Torrent Queue Operations and Lifecycle Visibility' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 9: Subtitle Variant Console (Bazarr-Inspired)' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 10: Settings Surface' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 11: Unified Dashboard and Operational Health' (Protocol in workflow.md)
...
- [ ] Task: Measure - User Manual Verification 'Phase 12: Activity Center, E2E Journeys, and Quality Gates' (Protocol in workflow.md)
