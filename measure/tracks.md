...
- [ ] **Track: Remaining Server Service Test Coverage** *Phases: 6 | Link: [./tracks/chore_remaining_server_service_coverage_20260728/](./tracks/chore_remaining_server_service_coverage_20260728/)* — Pending. Closes the last verified server-service coverage gap from tech-debt.md (2026-07-26): **7** of 55 services lack a sibling `.test.ts` (`ActivityEventEmitter`, `DataDirectoryInitializer`, `LibraryScanner`, `MetadataGenerator`, `MetadataProvider`, `ProbeMetadataParser`, `WantedService`), re-verified against source 2026-07-28. `ReleaseParserProvider` was on this list until 2026-07-28, when `bug_ai_release_parser_lockdown_20260728` rewrote the file and closed it there (73 tests, 100% branch) — do not re-plan it. TDD, ≥80% branch coverage per service; no production changes unless a defect is found.
