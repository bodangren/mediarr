...
- [ ] **Track: Typed getSeriesWithEpisodes API Response** *Phases: 4 | Link: [./archive/type_series_api_response_20260508/](./archive/type_series_api_response_20260508/)* — Zod schema for series detail API, eliminate `as any` casts in SeriesDetailPage and children
