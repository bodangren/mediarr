...
5. - [ ] **Track: Fix MediaSearchService Pre-existing Timeout Test Failures** *Phases: 5 | Link: [./tracks/bug_mediasearch_timeout_tests_20260630/](./tracks/bug_mediasearch_timeout_tests_20260630/)* — Eliminate 7 pre-existing timeout failures in MediaSearchService sibling tests caused by `vi.useFakeTimers()` blocking `setTimeout`-wrapped `searchWithTimeout`.
6. - [ ] **Track: App Workspace Pre-existing Test & Typecheck Cleanup** *Phases: 7 | Link: [./tracks/chore_app_pre_existing_failures_20260630/](./tracks/chore_app_pre_existing_failures_20260630/)* — Clear 4 app typecheck errors and ~133 app test failures so the app workspace passes green gates.
