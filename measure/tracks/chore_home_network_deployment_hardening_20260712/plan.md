...
- [x] **Phase 6 architectural fix — RESOLVED 2026-07-28 (`730a09ae`): rollup's default `maxParallelFileOps` (1000) exceeded the buildah `RUN` layer's fd soft limit (1024) by 5 descriptors.**
